...
INTERFACE /dmo/if_flight_legacy11
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL11
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel11     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING11
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking11    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_11
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_11 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT11
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight11 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id11.
  ...
  TYPES booking_id TYPE /dmo/booking_id11.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id11.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL11, /DMO/BOOKING11, /DMO/BOOK_SUP_11 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code11.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code11,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status11,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel11_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id11.
  INCLUDE TYPE /dmo/booking11_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id11.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id11.
  INCLUDE TYPE /dmo/book_sup_11_data.
