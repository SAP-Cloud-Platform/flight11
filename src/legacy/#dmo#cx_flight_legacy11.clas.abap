CLASS /dmo/cx_flight_legacy11 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_11',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_11',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id11 OPTIONAL
        booking_id            TYPE /dmo/booking_id11 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id11 OPTIONAL
        agency_id             TYPE /dmo/agency_id11 OPTIONAL
        customer_id           TYPE /dmo/customer_id11 OPTIONAL
        carrier_id            TYPE /dmo/carrier11-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_11-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_11-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date11 OPTIONAL
        end_date              TYPE /dmo/end_date11 OPTIONAL
        booking_date          TYPE /dmo/booking_date11 OPTIONAL
        flight_date           TYPE /dmo/flight_date11 OPTIONAL
        status                TYPE /dmo/travel_status11 OPTIONAL
        currency_code         TYPE /dmo/currency_code11 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id11,
          mv_booking_id            TYPE /dmo/booking_id11,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id11,
          mv_agency_id             TYPE /dmo/agency_id11,
          mv_customer_id           TYPE /dmo/customer_id11,
          mv_carrier_id            TYPE /dmo/carrier11-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_11-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_11-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date11,
          mv_end_date              TYPE /dmo/end_date11,
          mv_booking_date          TYPE /dmo/booking_date11,
          mv_flight_date           TYPE /dmo/flight_date11,
          mv_status                TYPE /dmo/travel_status11,
          mv_currency_code         TYPE /dmo/currency_code11,
...
CLASS /dmo/cx_flight_legacy11 IMPLEMENTATION.
