@AbapCatalog.sqlViewName: '/DMO/ICONNE_R11'
...
define view /DMO/I_Connection_R11
  as select from /dmo/connecti_11 as Connection

  association [1..*] to /DMO/I_Flight_R11 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier11  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport11',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
