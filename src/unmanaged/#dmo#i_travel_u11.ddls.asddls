@AbapCatalog.sqlViewName: '/DMO/ITRAV_U11'
...
define root view /DMO/I_Travel_U11
  as select from /dmo/travel11 as Travel -- the travel table is the data source for this view

  composition [0..*] of /DMO/I_Booking_U11 as _Booking

  association [0..1] to /DMO/I_Agency11       as _Agency    on $projection.AgencyID        = _Agency.AgencyID
  association [0..1] to /DMO/I_Customer11     as _Customer  on $projection.CustomerID      = _Customer.CustomerID
...

{
    ...
    @Consumption.valueHelpDefinition: [{ entity : {name: '/DMO/I_Agency11', element: 'AgencyID'  } }]
